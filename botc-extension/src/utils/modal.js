...
function initializeModalElements() {
    ...
    if (!modalElement || !modalTitleElement || !modalBodyElement || !modalActionsElement || !modalCloseButton) {
        ...
        // No longer assign dummy window object here, rely on initialization check in functions
        // If initialization fails, the functions below will return early or throw.
        return false;
    }
...
// Export ModalManager using ES Modules
export const ModalManager = {
    ...
    showNotification,
    closeModal,
    // We might not need to export initializeModalElements if it's purely internal
